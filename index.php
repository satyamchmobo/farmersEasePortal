...
<html lang="en">
	...
	?>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Farmer Portal &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Farmer Portal Fam<span>Alpha Team [VIT]</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:farmerculture@gmail.com" style="color:white">roshan.pawar19@vit.edu</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Farmer Portal</b></span>
				Vandan Kulkarni 34<br/>
				Roshan Pawar 43<br/>
				Satyam Chourasia 46
			</p>
...
<section>
							...
							<form method="post" action="Login/signUp.php">
								...
								<div class="row uniform">
			                        ...
			                        <div class="3u 12u$(small)">
			                            <input type="radio" id = "Rfarmer" name="portal" value="1" >
			                            <label for="Rfarmer">Farmer</label>
			                        </div>
			                        <div class="3u 12u$(small)">
			                            <input type="radio" id = "Rbuyer" name="portal" value="0" checked>
