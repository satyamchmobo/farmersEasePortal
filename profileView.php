    ...
    <body>
        ...
        <section id="one" class="wrapper style1 align">
            <div class="inner">
                ...
                <header>
                    <center>
                    <span><img src="images/profileImages/profile0.jpeg" class="image-circle" class="img-responsive" height="200%"></span>
                    <br>
                                ...
                                <div class="row uniform">
                                    ...
                                    <div class="3u 12u$(xsmall)">
            							<a href="uploadProduct.php" class="btn btn-danger" style="text-decoration: none;">Upload Product</a>
                                                  ...
                                                  <div class="3u 12u$(xsmall)">
            							<a href="uploadQrCode.php" class="btn btn-primary" style="text-decoration: none;">Upload QR Code</a>
            						</div>
                                    <div class="3u 12u$(large)">
