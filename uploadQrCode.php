<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
		...
		$sql = "INSERT INTO fqrcode (fid,image)
			   VALUES ('$fid', '$pic')";
  ...
  <div style= "width: 1000px;
				       ...
				       <div class="container">
					        <form method="POST" action="uploadProduct.php" enctype="multipart/form-data">
						        <h2>Upload your qr code for payment recieve</h2>
						          <br>
				                    <center>
	...
	<div style= " height: 200px;width: 200px;">	
					   <img src="images/profileImages/profile0.jpeg" class="image-circle" class="img-responsive" height="200%"> 
					   <b>
					Example QR code of phone pay</b>
                     </div>
